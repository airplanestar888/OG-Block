...
import { getConfigValues, OG_CARD_CONTRACT_KEY, OG_CARD_CHAIN_ID_KEY } from "@/lib/app-config";
    ...
    <main className="mx-auto max-w-2xl space-y-8 px-4 py-12">
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-black/55">
          Signed in as @{user.x_handle}. Changes save to the database and take effect immediately — no redeploy.
        </p>
      </div>
